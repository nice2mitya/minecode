#!/usr/bin/env python3
"""Generate Spanish static version of MineCode pages under public/es."""
...
def main() -> None:
    ...
    html_files = sorted(p for p in PUBLIC_DIR.rglob("*.html") if "/es/" not in p.as_posix())
    cache: dict[str, str] = {}
